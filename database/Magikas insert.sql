...
insert into card (crd_name, crd_description) values('Forest','Forest absorvs Light and Water');
insert into card (crd_name, crd_description) values('Water','Water beats Fire and eates Light');
...
insert into playermatch (pm_player_id,pm_match_id,pm_state_id,pm_hp) values (1,1,1,10);
insert into playermatch (pm_player_id,pm_match_id,pm_state_id,pm_hp) values (2,1,4,10);
...
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (1,1,1,1);
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (1,1,3,1);
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (1,1,1,1);
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (2,1,2,1);
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (2,1,5,1);
insert into deck (deck_pm_id,deck_pos_id,deck_card_id,deck_card_hp) values (2,1,3,1);
